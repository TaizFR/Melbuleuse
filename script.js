...
const BOOKING_URLS = {
    // SEMI-PERMANENT
    'semi-permanent-n1-nodepose': '',
    'semi-permanent-n1-depose': '',
    'semi-permanent-n1-depose-exterieur': '',
    'semi-permanent-n2-nodepose': '',
    'semi-permanent-n2-depose': '',
    'semi-permanent-n2-depose-exterieur': '',
    'semi-permanent-n3-nodepose': '',
    'semi-permanent-n3-depose': '',
    'semi-permanent-n3-depose-exterieur': '',
    'semi-permanent-n4-nodepose': '',
    'semi-permanent-n4-depose': '',
    'semi-permanent-n4-depose-exterieur': '',
    'semi-permanent-n5-nodepose': '',
    'semi-permanent-n5-depose': '',
    'semi-permanent-n5-depose-exterieur': '',

    // GAINAGE
    'gainage-n1-nodepose': '',
    'gainage-n1-depose': '',
    'gainage-n1-depose-exterieur': '',
    'gainage-n2-nodepose': '',
    'gainage-n2-depose': '',
    'gainage-n2-depose-exterieur': '',
    'gainage-n3-nodepose': '',
    'gainage-n3-depose': '',
    'gainage-n3-depose-exterieur': '',
    'gainage-n4-nodepose': '',
    'gainage-n4-depose': '',
    'gainage-n4-depose-exterieur': '',
    'gainage-n5-nodepose': '',
    'gainage-n5-depose': '',
    'gainage-n5-depose-exterieur': '',

    // GEL-X SML
    'gel-x-sml-n1-nodepose': '',
    'gel-x-sml-n1-depose': 'https://cal.com/melbuleuse/gel-x-sml-n1-depose',
    'gel-x-sml-n1-depose-exterieur': '',
    'gel-x-sml-n2-nodepose': '',
    ...
    // GEL-X XL
    'gel-x-xl-n1-nodepose': '',
    'gel-x-xl-n1-depose': '',
    'gel-x-xl-n1-depose-exterieur': '',
    'gel-x-xl-n2-nodepose': '',
    'gel-x-xl-n2-depose': '',
    'gel-x-xl-n2-depose-exterieur': '',
    'gel-x-xl-n3-nodepose': '',
    'gel-x-xl-n3-depose': '',
    'gel-x-xl-n3-depose-exterieur': '',
    'gel-x-xl-n4-nodepose': '',
    'gel-x-xl-n4-depose': '',
    'gel-x-xl-n4-depose-exterieur': '',
    'gel-x-xl-n5-nodepose': '',
    'gel-x-xl-n5-depose': '',
...
function generateBookingKey() {
    let key = currentSelection.service;

    if (currentSelection.service === 'depose-seule') {
        key += `-${currentSelection.deposeSeuleType}`;
    } else {
        if (currentSelection.taille) key += `-${currentSelection.taille}`;
        if (currentSelection.niveau) key += `-n${currentSelection.niveau}`;
        key += currentSelection.depose ? `-${currentSelection.depose}` : `-nodepose`;
    }
...
function redirectToBooking() {
    ...
    const url = BOOKING_URLS[key];

    if (url) {
        window.open(url, '_blank');
    } else {
        alert(`Aucune URL configurée pour : ${key}`);
    }
}
